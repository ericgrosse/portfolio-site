    ...
    return (
      <div className="AboutMe" id="home">
        <div className="grid-container">
          ...
          <div className="info">
            <p>Hi, I'm Eric Grossé, a frontend web developer from Montreal, Canada. I've been working in web development for over two years, ranging from freelance work to employment from startups and large corporations.</p>
